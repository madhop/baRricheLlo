...
This paper \cite{cinesi} aims at improving the achievements of DQlfD \cite{dqlfd} in integrating reinforcement learning with human demonstrations using TORCS.
